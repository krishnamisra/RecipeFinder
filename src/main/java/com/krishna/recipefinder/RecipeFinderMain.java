	...
	public static void main(String[] args) {
		if (args.length >= 2 && args.length <= 3) {
			try {
				...
				String returnValue = recipeFinderService
						.getRecipeRecommendation(new File(ingredientsFileName),
				...
				System.out.println("Exception in RecipeFinderMain Class"
						+ e.getMessage());
				...
				System.out.println("GeneralException in RecipeFinderMain Class"
						+ e.getMessage());
			...
			System.out
					.println("This is not valid input.\n1. First arguement should be"
